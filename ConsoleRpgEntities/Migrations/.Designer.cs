...
{
    // Update the method signature to use the `override` keyword to fix the CS0114 error.  
    [DbContext(typeof(GameContext))]
    [Migration("20250427010425_AddEquipmentIdToPlayer")]
    partial class AddEquipmentIdToPlayer
    {
